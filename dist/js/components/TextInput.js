...
var TextInput = function (_a, ref) {
    ...
    return (React.createElement(React.Fragment, null,
        label ? (React.createElement(Label, { labelClassName: variant === "dark-blue" ? "h-color-text-blue-200 ".concat(labelClassName) : labelClassName, htmlFor: id ? id : uniqueIDRef.current }, label)) : null,
