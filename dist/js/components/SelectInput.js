...
var SelectInput = function (_a, ref) {
    var className = _a.className, _b = _a.id, id = _b === void 0 ? randomString() : _b, label = _a.label, labelClassName = _a.labelClassName, placeholder = _a.placeholder, value = _a.value, _c = _a.type, type = _c === void 0 ? "button" : _c, rest = __rest(_a, ["className", "id", "label", "labelClassName", "placeholder", "value", "type"]);
