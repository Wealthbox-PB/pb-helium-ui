...
var Input = function (_a) {
    ...
    return (React.createElement("label", { className: "h-width-100" },
        label ?
            React.createElement(Label, { labelText: label, labelClassName: variant === "dark-blue" ? "h-color-text-blue-200 ".concat(labelClassName) : labelClassName, htmlFor: id })
            :
                null,
        React.createElement("div", { className: "h-input-container" },
            React.createElement("input", { id: id, disabled: disabled, type: inputType, ref: input, name: name, "aria-label": name, className: classNames("h-input", inputClassName, {
