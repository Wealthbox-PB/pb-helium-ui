...
var Input = function (_a) {
    var _b = _a.autofocus, autofocus = _b === void 0 ? false : _b, _c = _a.disabled, disabled = _c === void 0 ? false : _c, inputClasses = _a.inputClasses, label = _a.label, _d = _a.labelClasses, labelClasses = _d === void 0 ? "" : _d, leftIconClass = _a.leftIconClass, name = _a.name, onBlur = _a.onBlur, onChange = _a.onChange, onFocus = _a.onFocus, onRightButtonClick = _a.onRightButtonClick, placeholder = _a.placeholder, rightButtonClass = _a.rightButtonClass, _e = _a.role, role = _e === void 0 ? "textbox" : _e, _f = _a.showRightButton, showRightButton = _f === void 0 ? true : _f, _g = _a.theme, theme = _g === void 0 ? "light" : _g, _h = _a.type, type = _h === void 0 ? "text" : _h, value = _a.value;
