...
var HeliumDialogFooter = function (_a) {
    ...
    return (React.createElement("div", { className: "h-react-dialog__footer " + (footerBackground && "h-react-dialog__footer--with-background") + " " + footerClass }, children
        ? children
        : React.createElement("div", { className: "h-react-dialog__footer-cta-container" },
            React.createElement("button", { onClick: closeDialog, className: "h-btn h-btn--secondary" }, "Cancel"),
            submitHandler &&
                React.createElement("button", { onClick: submitHandler, className: "h-btn h-btn--positive h-btn-margin-left" }, "Submit"))));
};
