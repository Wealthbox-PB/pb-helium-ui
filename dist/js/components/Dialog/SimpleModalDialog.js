...
var SimpleModalDialog = function (_a) {
    ...
    return (React.createElement(ModalDialog, { backdrop: backdrop, backdropClassName: backdropClassName, closeDialog: closeDialog, dialogClassName: dialogClassName, initialFocusEl: initialFocusEl, open: open, position: position, returnFocusEl: returnFocusEl, size: size, trapPaused: trapPaused },
