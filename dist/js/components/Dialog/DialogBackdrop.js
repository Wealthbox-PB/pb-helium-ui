...
export var DialogBackdrop = function (_a) {
    ...
    return (React.createElement("button", { type: "button", className: classNames("h-dialog__backdrop h-cursor-auto", className), onClick: handleClose, "aria-label": "Close Dialog" }));
};
