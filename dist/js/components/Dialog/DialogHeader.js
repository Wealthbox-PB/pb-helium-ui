...
var HeliumDialogHeader = function (_a) {
    ...
    return (React.createElement("div", { className: "h-react-dialog__header " + headerClass },
        ...
        isModalDialog && closeDialog && closeInHeader && (React.createElement("button", { type: "button", className: "h-react-dialog__close", "aria-label": "Close Dialog", onClick: closeDialog },
