...
var DialogBody = function (_a) {
    ...
    return (React.createElement("div", { className: classNames("h-dialog__body", bodyClassName), id: ariaDescriptionSelector || context.ariaDescriptionSelector, "data-testid": "h-dialog__body" }, children));
};
export { DialogBody };
