...
function App() {
    ...
    return (React.createElement("div", { className: "App" },
        ...
        React.createElement(HeliumDialog, { hasFooter: false, size: "small", position: "bottom center", open: is2ndDialogOpen, closeDialog: close2ndDialog, footerBackground: false, submitHandler: function () { return console.log("I submit!"); } },
