...
var LinkButton = function (_a) {
    ...
    return (React.createElement("a", { onClick: onClick, href: href, target: isExternal ? "_blank" : undefined, rel: isExternal ? "noopener noreferrer" : undefined, className: classNames("h-btn h-btn--" + variant + " h-btn--" + size, className, {
            'h-btn--active': active,
            'h-btn--focus': focus,
            'h-btn--square': square,
        }) }, children));
