...
var MultiSelect = function (_a) {
    var initialOptions = _a.initialOptions, renderOpener = _a.renderOpener, _b = _a.allowCustomValue, allowCustomValue = _b === void 0 ? false : _b, _c = _a.flip, flip = _c === void 0 ? true : _c, _d = _a.height, height = _d === void 0 ? "auto" : _d, _e = _a.initialSelectedValue, initialSelectedValue = _e === void 0 ? [] : _e, maxHeight = _a.maxHeight, minHeight = _a.minHeight, name = _a.name, onSelect = _a.onSelect, _f = _a.placement, placement = _f === void 0 ? "bottom-end" : _f, portalProps = _a.portalProps, _g = _a.searchable, searchable = _g === void 0 ? false : _g, _h = _a.width, width = _h === void 0 ? "auto" : _h;
    ...
    useEffect(function () {
        onSelect === null || onSelect === void 0 ? void 0 : onSelect(multiSelectValue);
