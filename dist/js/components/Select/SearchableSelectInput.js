...
export var SearchableSelectInput = function (_a) {
    var options = _a.options, className = _a.className, handleQuery = _a.handleQuery, inputClassName = _a.inputClassName, multiSelect = _a.multiSelect, _b = _a.placeholder, placeholder = _b === void 0 ? "Search..." : _b, props = __rest(_a, ["options", "className", "handleQuery", "inputClassName", "multiSelect", "placeholder"]);
    ...
    return (React.createElement("div", { className: classNames("h-border-bottom-shared-component p-2", className) },
        React.createElement(TextInput, __assign({ type: "text", leftIconClassName: "h-icon-search", className: inputClassName, placeholder: placeholder, onChange: function (e) {
                ...
                if (e.key === "Enter") {
                    ...
                    if (activeIndex !== null) {
                        multiSelect
                            ? handleMultiSelect === null || handleMultiSelect === void 0 ? void 0 : handleMultiSelect(options[activeIndex])
                            : handleSearchableSelect === null || handleSearchableSelect === void 0 ? void 0 : handleSearchableSelect(options[activeIndex].label, options[activeIndex].value);
                    }
                }
